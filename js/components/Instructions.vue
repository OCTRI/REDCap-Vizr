<template>
  <ul id="vizr-instructions" class="list-unstyled" v-if="showInstructions">
    ...
    <li v-if="showNoChartInstructions" data-no-charts>{{ messages.threeComponents }}
      <ul>
      ...
      <div id="collapseMore" class="collapse">
        <li class="more-li">{{ messages.moreInfo.timeConfigTitle }}
          <ul>
            ...
            <li>{{ messages.timeConfig.interval }}
              <ul>
        ...
        <li class="more-li">{{ messages.moreInfo.dataConfigTitle }}
          <ul>
            <li>{{ messages.dataConfig.filterLogic }}
              <ul>
                <li>{{ messages.dataConfig.filterLogicDetails }}</li>
              </ul>
            </li>
            <li>{{ messages.dataConfig.groupingEvent }}
              <ul>
                <li>{{ messages.dataConfig.groupingEventDetails }}</li>
              </ul>
            </li>
            <li>{{ messages.dataConfig.groupingField }}
              <ul>
        ...
        <li class="more-li">{{ messages.moreInfo.targetTitle }}
          <ul>
            <li>{{ messages.targetConfig.targetCount }}
              <ul>
                <li>{{ messages.targetConfig.targetCountDetails }}</li>
                <li>{{ messages.targetConfig.targetGroup }}</li>
              </ul>
            </li>
            <li>{{ messages.targetConfig.targetEndDate }}
              <ul>
        ...
        <li class="more-li">{{ messages.moreInfo.resultsTitle }}
          <ul>
