...
describe('Vizr.vue', () => {
  ...
  xdescribe('when plugin is started', function() {
    ...
    xdescribe('and longitudinal charts are defined', function(){
      let metadataRequest, configRequest, dataRequest;
      ...
      xdescribe('and data for multiple events is received', function() {
        beforeEach(function() {
          dataRequest = jasmine.Ajax.requests.mostRecent();
    ...
    xdescribe('and chart definition has no groups', function(){
      let metadataRequest, configRequest, dataRequest;
  ...
  describe('when user can edit', function() {
    let originalDatepicker, wrapper;
    ...
    describe('and no charts are defined', function() {
      ...
      it('shows example', function() {
        const example = wrapper.find('.vizr-example');
        expect(example.isVisible()).toBe(true);
      });

      it('shows instructions', () => {
        const instructions = wrapper.find('#vizr-instructions');
        expect(instructions.isVisible()).toBe(true);
      });

      it('no charts are displayed', function() {
        const charts = wrapper.findAll('.vizr-chart-container');
        expect(charts.exists()).toBe(false);
      });

      it('shows the chart build button', function() {
        const newChartButton = wrapper.find('button.btn-warning');
        expect(newChartButton.exists()).toBe(true);
      });
  ...
  xdescribe('when user cannot edit', function() {
    let originalDatepicker;
